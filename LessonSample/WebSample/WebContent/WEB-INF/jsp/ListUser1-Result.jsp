	...
	<table class="table table-bordered table-hover table-striped">
		...
		<thead>
			<tr>
				...
				<th>工资</th>
				<th>爱好</th>
				<th class="text-center"><a href="AddUser1" class="btn btn-primary btn-xs" role="button">添加</a></th>
			</tr>
		</thead>
		<tbody>
			<c:forEach items="${reqResult}" var="user">
				<tr>
					...
					<a href="ChgUser1?id=${user.id}"  class="btn btn-primary btn-xs" role="button">修改</a> 
					<a href="DelUser1?id=${user.id}"  class="btn btn-primary btn-xs" role="button">删除</a>
						</td>
				</tr>
			</c:forEach>
		</tbody>
