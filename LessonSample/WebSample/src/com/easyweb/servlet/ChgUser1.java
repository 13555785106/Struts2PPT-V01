...
import com.easyweb.model.User1;
import com.easyweb.model.User1Datas;

@WebServlet("/sample/ChgUser1")
public class ChgUser1 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		User1 user = User1Datas.getInstance().getUser(id);
		request.setAttribute(REQ_PARAMS, user);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (reqErrors.size() > 0) {
			...
			User1 user = User1Datas.getInstance().getUser(request.getParameter("id"));
			...
			if (User1Datas.getInstance().chgUser(user)) {
				response.sendRedirect("ListUser1");
				return;
			}
		}
